  ...
  return (
      <div className=''>
          <div className='text-white text-center flex flex-col items-center justify-center'>
             ...
             <h1 className='text-5xl lg:text-9xl font-bold myshadow anime-h'>WebDeveloper</h1>
              <h1 className='text-5xl lg:text-9xl font-bold myshadow anime-h'>WebDesigner</h1>

  ...
  return (
      <div className='p-10 lg:m-10 m-5'>
         ...
         <form className='flex flex-col justify-center items-center ' ref={form} onSubmit={sendEmail}>
            ...
            <input className='lg:w-[400px] lg:h-[40px] w-[200px] text-start p-3' type="text" name="user_name"  placeholder='jane doe'/>
            <label className='whatDo'>Email</label>
            <input className='lg:w-[400px] lg:h-[40px] w-[200px] text-start p-3'  type="email" name="user_email" placeholder='youremail@gmail.com' />
